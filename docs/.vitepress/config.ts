...
// it goes stale on the very next release.
...
const site = 'https://linkwarden-mcp.ni-c.de';
const description =
  'MCP server for Linkwarden: search your bookmarks, organise them into collections and tags, and read the article text of a page Linkwarden has preserved.';

export default defineConfig({
  title: 'linkwarden-mcp',
  description,
  lang: 'en-US',
  cleanUrls: true,
  lastUpdated: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'linkwarden-mcp' }],
    ['meta', { property: 'og:title', content: 'linkwarden-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Releases',
            link: 'https://github.com/ni-c/linkwarden-mcp/releases',
          },
          {
            text: 'npm package',
            link: 'https://www.npmjs.com/package/linkwarden-mcp',
          },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is linkwarden-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/linkwarden-mcp' },
    ...
    editLink: {
      pattern: 'https://github.com/ni-c/linkwarden-mcp/edit/main/docs/:path',
