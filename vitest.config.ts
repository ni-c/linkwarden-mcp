...
export default defineConfig({
  test: {
    ...
    // needs a Linkwarden, a Postgres and a Meilisearch in Docker. Excluding it
    // here keeps `npm test` runnable with nothing installed, and keeps the
    // coverage numbers below comparable to what they measured before.
